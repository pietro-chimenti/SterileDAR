...
plt.plot(E,cs.vbarvbar1n,'salmon',linewidth=1.0,label=r'$\bar{\nu_{x}}+^{208}$Pb$\rightarrow ^{207}$Pb$+n+\bar{\nu_{x}}$')
plt.plot(E,cs.vbarvbar2n,'black',linewidth=1.0,label=r'$\bar{\nu_{x}}+ ^{208}$Pb$\rightarrow ^{206}$Pb$+2n+\bar{\nu_{x}}$')
plt.plot(E,cs.vbarvbartotal,'darkgrey',linewidth=1.0,label=r'$\bar{\nu_{x}} \rightarrow \bar{\nu_{x}}$')
