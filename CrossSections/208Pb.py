...
plt.plot(E,vee1n,'r',linewidth=1.0,label=r'$\nu_{e}+^{208}$Pb$\rightarrow ^{207}$Bi$+n+e^{-}$')
plt.plot(E,vee2n,'b',linewidth=1.0,label=r'$\nu_{e}+^{208}$Pb$\rightarrow ^{206}$Bi$+2n+e^{-}$')
plt.plot(E,veetotal,'g',linewidth=1.0,label=r'$\nu_{e} \rightarrow e^{-}$')
plt.plot(E,vv1n,'c',linewidth=1.0,label=r'$\nu_{x}+^{208}$Pb$\rightarrow ^{207}$Pb$+n+\bar{\nu_{x}}$')
plt.plot(E,vv2n,'m',linewidth=1.0,label=r'$\nu_{x}+^{208}$Pb$\rightarrow ^{207}$Pb$+2n+\bar{\nu_{x}}$')
plt.plot(E,vvtotal,'y',linewidth=1.0,label=r'$\nu_{x} \rightarrow \nu_{x}$')
plt.plot(E,vbarvbar1n,'k',linewidth=1.0,label=r'$\bar{\nu_{x}}+^{208}$Pb$\rightarrow ^{207}$Pb$+n+\bar{\nu_{x}}$')
plt.plot(E,vbarvbar2n,'navy',linewidth=1.0,label=r'$\bar{\nu_{x}}+ ^{208}$Pb$\rightarrow ^{206}$Pb$+2n+\bar{\nu_{x}}$')
plt.plot(E,vbarvbartotal,'deeppink',linewidth=1.0,label=r'$\bar{\nu_{x}} \rightarrow \bar{\nu_{x}}$')
