# This code plots a histogram of the calculated number of interactions of electron neutrinos,
# compares with samples generated by a random number generator and plot Chi^2 next to the minimum
